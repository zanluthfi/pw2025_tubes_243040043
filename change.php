    ...
    <div class="container-sm bg-dark p-5">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="model" id="model" value="<?= $model ?>" require>
            </div>

            <div class="mb-3">
                <label for="launchYear" class="form-label">Launch Year</label>
                <input type="number" class="form-control" name="launchYear" id="launchYear" value="<?= $launchYear ?>" require>
            </div>
            ...
            <div class="mb-3">
                <div class="mb-3">
                    <label for="image" class="d-block form-label">Image</label>
                    <img src="img/<?= $image ?>" class="d-block img-fluid mb-3" alt="image">
